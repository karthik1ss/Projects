...
public class InsertAsset extends HttpServlet {
	...
	private String parse_a_string(String xmlstring)
    {
        ...
        {		        
		        ...
		        for(int s = 0; s < nodeLst.getLength(); s++)
		        {
		            ...
		            if(fstNode.getNodeType() == 1)
		            {
		                ...
		                projectid = projectids.item(0).getNodeValue();
		...
		int pid=Integer.parseInt(projectid);
		            ...
		            i = st.executeUpdate("INSERT INTO projectassets(projectassetType,projectid,contentDescription, contentName, contentSource, contentType,type) VALUES" +
		            		" ('"+assetid+"',"+pid+",'"+contentDescription+"', '"+contentName+"','"+contentSource+"','"+contentType+"','"+type+"')");
