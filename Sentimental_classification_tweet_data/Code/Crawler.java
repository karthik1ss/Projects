...
import org.apache.hadoop.util.*;
	...
	public class HW1_1 
	{
	    ...
	    public static void main(String[] args) throws Exception 
	    {
	         ...
	         JobConf conf = new JobConf(HW1_1.class);          // Create a JobConf object
	         ...
	         conf.setMapperClass(HW1_1.WordCountMap.class);					// specifies the mapper class
	 	     conf.setCombinerClass(HW1_1.WordCountReduce.class); 			// specifies the combiner
	 	     conf.setReducerClass(HW1_1.WordCountReduce.class); 			// specifies the reducer
	        ...
	        job.setMapperClass(HW1_1.Top10Map.class);					// specifies the mapper class
	        job.setCombinerClass(HW1_1.Top10Reduce.class); 			// specifies the combiner
	        job.setReducerClass(HW1_1.Top10Reduce.class); 			// specifies the reducer
