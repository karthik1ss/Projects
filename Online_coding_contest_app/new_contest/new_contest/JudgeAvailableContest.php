	...
	<div id="inner">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="JudgeHome.php">My Account</a></li>
...
?>
    ...
    <h1><p>Registered Contests(for grading)</p></h1>
	<?php
...
while($row = mysql_fetch_array($result1)){
	 ...
	 <form name="form1" method="post" action="inputContest.php">
	...
	if(!($exist==1)){ echo ("The contest is already being judged by someone else currently or the contest does not exist");}	 ?>
    <!-- end .content --></div>
    </div>
  <!-- end .container --></div>
</body>
