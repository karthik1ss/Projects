...
<div class="container">
  <div class="header">
    <h1><a href="#"><img src="ut-dallas-logo.jpg" alt="Insert Logo Here" name="Insert_logo" width="300" height="111" id="Insert_logo" style="background-color: #C6D580; display:block;" />	Competetion Detail Page:</a></h1> 
  ...
  <div class="content">
    <p><strong>String Similarity (25 Points)</strong></p>
    ...
    <p><strong>Output:</strong><br />
      Output T lines containing the answer for the corresponding test case.</p>
    <p><strong>Constraints:</strong><br />
      1 &lt;= T &lt;= 10<br />
      The length of each string is at most 100000 and contains only lower case characters.</p>
              ...
              <blockquote>
                <blockquote>
                  <blockquote>
                    <p>&nbsp;                    </p>
                    <p>
                      <input type="submit" name="Register" id="Register" value="Register for this Contest" />
                    </p>
                  </blockquote>
                </blockquote>
              </blockquote>
