...
<title>Onetime User Registration</title>
...
// 		echo $_SESSION['username'];
	?>
	    <form method="post" action="OnetimeUserRegistration.php" name="form1" class="style1">
	       <p>&nbsp;</p>
	       <h1>Onetime User Registration</h1><br /><br />
